...
# named_dist_mat = load("data/named_dist_mat.jld2")["named_dist_mat"]
# dist_mat = load("data/named_dist_mat.jld2")["dist_mat"]
...
cases_dest_prob_mat = let
    ...
    _cases_dest_prob_mat = dest_prob_mat[idxs, idxs]
